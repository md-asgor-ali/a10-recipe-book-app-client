        ...
        {recipes.map((recipe) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 mb-1">Cuisine: <span className="font-medium">{recipe.cuisine}</span></p>
              <p className="text-gray-600 mb-3">Likes: <span className="font-medium">{recipe.likeCount}</span></p>
