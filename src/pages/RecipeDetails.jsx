...
const RecipeDetails = () => {
  ...
  const handleLike = () => {
    ...
    fetch(`http://localhost:5000/recipes/${id}/like`, {
      ...
      .then(() => {
        ...
        window.dispatchEvent(new CustomEvent('recipeLiked', { detail: { recipeId: id } }));
      })
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 text-lg mt-1">{likeCount} people interested in this recipe</p>
      ...
      <div className="mt-6 space-y-2">
        ...
        <div>
          ...
          <ul className="list-disc ml-6">
            {recipe.ingredients.split(',').map((item, i) => <li key={i}>{item.trim()}</li>)}
          </ul>
        </div>
